<template>
  <div class="relative flex flex-col gap-10 bg-gray-100 py-5">
    <div class="gap flex flex-col items-center gap-5">
      <img class="h-auto w-1/2" src="../assets/Logo_ucl.svg" alt="Logo de UCL" />
