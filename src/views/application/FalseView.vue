<template>
  <HeaderApp />
  <div class="static grid h-screen grid-flow-row gap-5 overflow-y-auto px-4 pt-5 pb-28">
    <div class="flex flex-col items-center justify-center gap-10">
      <h2 class="text-4xl font-bold uppercase">C'est faux...</h2>
      <div class="flex flex-col gap-14">
        <div class="flex flex-col items-center gap-2">
          <p>La bonne réponse était :</p>
          <p class="text-2xl">Tyler est fou, il n’a pas d’ami</p>
        </div>
        <RouterLink class="flex justify-center" to="/dashboard">
